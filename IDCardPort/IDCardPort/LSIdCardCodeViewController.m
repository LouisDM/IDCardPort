...
@interface LSIdCardCodeViewController ()<CaptureDelegate>
{
    Capture *_capture;
...
@implementation LSIdCardCodeViewController
...
- (void)viewDidLoad {
    ...
    NSMutableArray *items = [NSMutableArray arrayWithObjects: close, flex, start, flex, save,nil];
...
- (void)closeAction
{
    ...
    self.idCardCodeCancelBlock(self);
}
...
- (void)startAction
{
    ...
    self.idCardCodeAgainBlock(self);
}
...
{
    //回调
    self.idCardCodeSuccessBlock(self,idInfo);
